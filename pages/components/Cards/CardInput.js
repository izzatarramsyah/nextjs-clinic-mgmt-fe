...
export default function CardInput({ handleSave, isLoading }) {
                    ...
                    <div className="relative w-full mb-6">
                      ...
                      <div class="flex gap-20">
                        <div class="flex items-center me-4">
                            <input id="inline-radio" type="radio" value='L' onClick={(e) => setGender(e.target.value)} name="inline-radio-group" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                            <label for="inline-radio" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Pria</label>
                        </div>
                        <div class="flex items-center me-4">
                            <input id="inline-2-radio" type="radio" value='P' onClick={(e) => setGender(e.target.value)} name="inline-radio-group" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                            <label for="inline-2-radio" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Wanita</label>
                        </div>
                      </div>
                    </div>
                  </div>
